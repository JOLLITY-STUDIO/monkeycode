...
// ============================================================
class RomInits extends RomProgram_1.RomProgram {
    ...
    initInputState() {
        // 清空输入核心变量区域
        this.ram.write16(RomProgram_1.RAM_VARS.INPUT_CURRENT, 0);
        this.ram.write16(RomProgram_1.RAM_VARS.INPUT_PREV, 0);
        this.ram.write16(RomProgram_1.RAM_VARS.INPUT_PRESSED, 0);
        // $FF9050-$FF905A 区域清零
    ...
    initSystem() {
        ...
        this.writeRamVar(RomProgram_1.RAM_VARS.GAME_PHASE, 0, 2);
        // 设置任务调度指针
        this.writeRamVar(RomProgram_1.RAM_VARS.TASK_PTR, 0, 4);
    }
    // ================================================================
    ...
    static ROM_SCENE_NAME = 0x061AC5;
    /** ROM 0x097404: 单位组配置数据 (FFFF 终止) */
    static ROM_UNIT_GROUPS = 0x097404;
    /** ROM 0x05E64A: 角色能力初始表 (10 角色 × 14B 有效) */
    static ROM_CHAR_ABILITY_TABLE = 0x05E64A;
    /** RAM 0xFFFFA4CC: 角色能力运行时表 (10 角色 × 24B) */
    static RAM_CHAR_ABILITY = 0xFFFFA4CC;
    /** 角色数 */
    static CHAR_COUNT = 10;
    /** 每角色源数据大小 */
    static CHAR_SRC_SIZE = 14;
    /** 每角色运行时槽大小 */
    static CHAR_SLOT_SIZE = 24;
    initGameMain() {
        // ── §2.1: 子系统初始化 ──
        ...
        this.ram.write32(RomProgram_1.RAM_VARS.TASK_PTR, 0);
    }
    // ================================================================
    ...
    // ================================================================
    _copyRomString(romAddr, ramAddr) {
        let i = 0;
        while (true) {
    ...
    // ================================================================
    _copyRomWordArray(romAddr, ramAddr) {
        let i = 0;
        while (true) {
