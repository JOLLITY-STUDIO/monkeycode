...
exports.TileDecoder = void 0;
class TileDecoder {
    /** 8×8 tile 在 RGBA buffer 中的像素步长 (通常=屏幕宽度) */
    _stride;
    constructor(stride = 320) {
        this._stride = stride;
    }
    set stride(value) {
        this._stride = value;
     ...
     */
    decodeToImageData(tileData, cram, palette, transparent, dst, dstX, dstY, hFlip = false, vFlip = false) {
        for (let y = 0; y < 8; y++) {
            ...
            for (let x = 0; x < 8; x++) {
                ...
                const colorIdx = ((tileData[rowBase + 0] >> bit) & 1) << 0 |
     ...
     * 返回 64 个 RGBA 值 (8×8)
     */
    decodeToRGBAArray(tileData, cram, palette, hFlip = false, vFlip = false) {
...
exports.TileDecoder = TileDecoder;
