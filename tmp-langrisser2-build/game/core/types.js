...
exports.SRAM = exports.JOYPAD_BITS = exports.IO_PORTS = exports.CompressType = exports.RESOURCES = exports.SPRITE = exports.DISPLAY = exports.VDP_STATUS = exports.VDP_REG_COUNT = exports.VDP_REG = exports.VDP_PORTS = exports.VSRAM_SIZE = exports.CRAM_SIZE = exports.VDP_VRAM_LAYOUT = exports.VRAM_SIZE = exports.RAM_SIZE = exports.ADDRESS_SPACE = exports.ROM_REGIONS = exports.ROM_RANGE = void 0;
// ============================================================
// ROM 内存布局
// ============================================================
/** ROM 地址范围 */
exports.ROM_RANGE = { start: 0x000000, end: 0x1FFFFF, size: 0x200000 };
/** ROM 内关键区域 */
exports.ROM_REGIONS = {
...
/** 68K 工作 RAM: 64KB */
exports.RAM_SIZE = 0x10000;
// ============================================================
// VDP 内存布局
// ============================================================
/** VRAM: 64KB */
exports.VRAM_SIZE = 0x10000;
/** VDP VRAM 区域 (按 VDP 寄存器配置) */
exports.VDP_VRAM_LAYOUT = {
...
exports.CRAM_SIZE = 128;
/** VSRAM: 40 word = 80 字节垂直滚动数据 */
exports.VSRAM_SIZE = 40;
// ============================================================
// VDP 端口地址 (68K 地址空间)
// ============================================================
exports.VDP_PORTS = {
...
(function (CompressType) {
    CompressType[CompressType["NIBBLE_RLE"] = 1] = "NIBBLE_RLE";
    CompressType[CompressType["BITPLANE"] = 2] = "BITPLANE";
    CompressType[CompressType["LZSS"] = 3] = "LZSS";
})(CompressType || (exports.CompressType = CompressType = {}));
// ============================================================
// 控制器
// ============================================================
exports.IO_PORTS = {
