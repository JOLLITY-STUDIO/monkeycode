...
class Lzss {
    /** 滑动窗口大小 */
    static WINDOW_SIZE = 0x1000; // 4096
    /** window write start position (matches ROM: move.w #$0FEE,d6) */
    static WINDOW_WRITE_START = 0x0FEE; // 4078
    /**
     * 解压 LZSS 数据
     *
     ...
     * @returns 解压后字节数
     */
    static decompress(rom, srcAddr, dstBuffer, dstOffset = 0, expectedSize) {
        let src = srcAddr;
        let dst = dstOffset;
