...
def main():
    ...
    curated_names = load_curated_names(CURATED_JSON, CURATED_JSON_BATCH2, CURATED_JSON_BATCH3, CURATED_JSON_BATCH4, CURATED_JSON_BATCH5, CURATED_JSON_BATCH6, CURATED_JSON_BATCH7, CURATED_JSON_BATCH8, CURATED_JSON_BATCH9, CURATED_JSON_BATCH10, CURATED_JSON_BATCH11, CURATED_JSON_BATCH12, CURATED_JSON_BATCH13, CURATED_JSON_BATCH14, CURATED_JSON_BATCH15, CURATED_JSON_BATCH16, CURATED_JSON_BATCH17)
    if curated_names:
        print(f'  Loaded curated names: {len(curated_names)} (V0.12 + V0.12.1 batch 2 + V0.12.2 batch 3 + V0.12.2 batch 4 + V0.14.2 batch 5 + V0.16 batch 6 + V0.17 batch 7-17)', file=sys.stderr)
