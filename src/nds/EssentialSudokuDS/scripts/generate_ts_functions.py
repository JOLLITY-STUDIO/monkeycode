...
CURATED_JSON_V019 = os.path.join(ROM_DIR, 'v019-pattern-remaining.json')
CURATED_JSON_V019B = os.path.join(ROM_DIR, 'v019-curated-batch.json')
CURATED_JSON_V019C = os.path.join(ROM_DIR, 'v019-curated-batch2.json')
CURATED_JSON_V019D = os.path.join(ROM_DIR, 'v019-curated-batch3.json')
