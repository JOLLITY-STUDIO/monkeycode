...
type TValue = string | ((...args: number[]) => string);
...
export const T: Record<Lang, Record<string, TValue>> = {
  en: {
    ...
    progressInProgress: (n: number) => `${n} in-progress`,
    progressEmpty: "No saved progress",
    progressJustNow: "Just now",
    progressMinAgo: (n: number) => `${n}m ago`,
    progressHourAgo: (n: number) => `${n}h ago`,
    progressDayAgo: (n: number) => `${n}d ago`,
    progressCellsStat: (m: number, t: number) => `${m}/${t} cells`,
    progressDelete: "Delete",
    progressClearAll: "Clear All",
    progressClearConfirmTitle: "Delete progress?",
    progressClearOneMsg: (id: number) => `Puzzle #${id} progress will be deleted.`,
    progressClearAllTitle: "Clear all progress?",
    progressClearAllMsg: (n: number) => `${n} puzzle progress will be cleared.`,
  ...
  tc: {
    ...
    puzzleFallback: (n: number) => `Picross ${n}`,
    progressTitle: "繼續",
    progressInProgress: (n: number) => `${n} 個進行中`,
    progressEmpty: "暫無保存的進度",
    progressJustNow: "剛剛",
    progressMinAgo: (n: number) => `${n} 分鐘前`,
    progressHourAgo: (n: number) => `${n} 小時前`,
    progressDayAgo: (n: number) => `${n} 天前`,
    progressCellsStat: (m: number, t: number) => `${m}/${t} 格`,
    progressDelete: "刪除",
    progressClearAll: "清空全部",
    progressClearConfirmTitle: "確認刪除進度",
    progressClearOneMsg: (id: number) => `題目 #${id} 的當前進度將被刪除。`,
    progressClearAllTitle: "清空全部進度",
    progressClearAllMsg: (n: number) => `目前 ${n} 個題目進度將被清除。`,
    progressConfirm: "確認",
    progressCancel: "取消",
    difficultyTitle: "拼圖",
  ...
  ja: {
    ...
    puzzleFallback: (n: number) => `Picross ${n}`,
    progressTitle: "続きから",
    progressInProgress: (n: number) => `${n} 件進行中`,
    progressEmpty: "保存された進行はありません",
    progressJustNow: "たった今",
    progressMinAgo: (n: number) => `${n} 分前`,
    progressHourAgo: (n: number) => `${n} 時間前`,
    progressDayAgo: (n: number) => `${n} 日前`,
    progressCellsStat: (m: number, t: number) => `${m}/${t} マス`,
    progressDelete: "削除",
    progressClearAll: "全部クリア",
    progressClearConfirmTitle: "進行を削除しますか",
    progressClearOneMsg: (id: number) => `問題 #${id} の進行を削除します。`,
    progressClearAllTitle: "全部の進行をクリア",
    progressClearAllMsg: (n: number) => `現在 ${n} 件の進行をクリアします。`,
    progressConfirm: "確認",
  ...
  ko: {
    ...
    puzzleFallback: (n: number) => `Picross ${n}`,
    progressTitle: "이어서",
    progressInProgress: (n: number) => `진행 중 ${n}개`,
    progressEmpty: "저장된 진행이 없습니다",
    progressJustNow: "방금 전",
    progressMinAgo: (n: number) => `${n}분 전`,
    progressHourAgo: (n: number) => `${n}시간 전`,
    progressDayAgo: (n: number) => `${n}일 전`,
    progressCellsStat: (m: number, t: number) => `${m}/${t}칸`,
    progressDelete: "삭제",
    progressClearAll: "모두 지우기",
    progressClearConfirmTitle: "진행을 삭제하시겠습니까?",
    progressClearOneMsg: (id: number) => `퍼즐 #${id}의 진행을 삭제합니다.`,
    progressClearAllTitle: "모든 진행 지우기",
    progressClearAllMsg: (n: number) => `현재 ${n}개의 진행을 모두 지웁니다.`,
    progressConfirm: "확인",
    progressCancel: "취소",
    difficultyTitle: "퍼즐",
