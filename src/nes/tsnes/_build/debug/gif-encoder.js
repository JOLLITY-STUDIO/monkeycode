    ...
    if (colorSet.size <= 254) {
        ...
        for (const frame of frames) {
            ...
            for (let i = 0; i < px.length; i++) {
                const c = px[i];
                if (c !== 0)
                    freq.set(c, ((_a = freq.get(c)) !== null && _a !== void 0 ? _a : 0) + 1);
            }
        }
...
function encodeFrame(frame, colorToIndex, minCodeSize) {
    ...
    for (let i = 0; i < px.length; i++) {
        ...
        indices.push((_a = colorToIndex.get(px[i])) !== null && _a !== void 0 ? _a : 0);
    }
...
function encodeGif(frames, options) {
    ...
    if ((options === null || options === void 0 ? void 0 : options.loop) !== false) {
