...
class DebugPanel {
    ...
    onTabSwitch(tab, prevTab) {
        ...
        this.page.setData(Object.assign(Object.assign(Object.assign({ debugTab: tab, debugLines: '', debugCanvasStyle: '' }, ntClear), ptClear), sptClear));
        if (tab === '' || tab === 'disasm') {
    ...
    _updatePaletteStrips(nes, types, tableAddrs) {
        const ppu = nes.ppu;
        const vramMem = ppu === null || ppu === void 0 ? void 0 : ppu.vramMem;
        if (!vramMem)
            return;
        const strips = [];
        for (let i = 0; i < types.length; i++) {
            ...
            strips.push({
                ...
                tableAddr: tableAddrs === null || tableAddrs === void 0 ? void 0 : tableAddrs[i],
                groups,
            });
        }
    ...
    _renderDisasm(sys) {
        ...
        if (!sys)
            return;
        const memRead = (addr) => { var _a; return (_a = sys.mem[addr & 0xffff]) !== null && _a !== void 0 ? _a : 0; };
        const pc = (((_a = sys.mem[0xFFFC]) !== null && _a !== void 0 ? _a : 0) | (((_b = sys.mem[0xFFFD]) !== null && _b !== void 0 ? _b : 0) << 8)) & 0xFFFF;
        try {
            ...
            text += `; Frame: #${this.fpsFrameCount}   A=$${(((_c = sys.mem[0x1A]) !== null && _c !== void 0 ? _c : 0) & 0xFF).toString(16).padStart(2, '0')}  X=$${(((_d = sys.mem[0x1B]) !== null && _d !== void 0 ? _d : 0) & 0xFF).toString(16).padStart(2, '0')}  Y=$${(((_e = sys.mem[0x1C]) !== null && _e !== void 0 ? _e : 0) & 0xFF).toString(16).padStart(2, '0')}\n`;
            text += `; SP=$${(((_f = sys.mem[0x19]) !== null && _f !== void 0 ? _f : 0) & 0xFF).toString(16).padStart(2, '0')}   P=$${(((_g = sys.mem[0x1D]) !== null && _g !== void 0 ? _g : 0) & 0xFF).toString(16).padStart(2, '0')}\n\n`;
