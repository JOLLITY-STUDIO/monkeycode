...
function generateNTDataText(nes, frameCount) {
    ...
    lines.push(`══════════════════════════════════════════════════════`);
    lines.push(`Frame: #${frameCount !== null && frameCount !== void 0 ? frameCount : '?'}  |  PPU $2000: regS=${ppu.regS} BG PT=${bgAddr}  SP PT=${spAddr}`);
...
function generatePaletteDataText(nes, frameCount) {
    ...
    const lines = [];
    lines.push(`══════════════════════════════════════════════`);
    lines.push(`Frame: #${frameCount !== null && frameCount !== void 0 ? frameCount : '?'}  |  Palette Data`);
    lines.push(`══════════════════════════════════════════════`);
    lines.push('');
    // emphasis 位
