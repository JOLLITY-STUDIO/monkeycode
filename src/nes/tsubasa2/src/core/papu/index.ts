...
class PAPU {
  ...
  private _onSample: AudioSampleCallback | null = null;
   ...
   */
  constructor(sampleRate: number = 44100, regBuffer?: Uint8Array | null) {
  ...
  /** 设置音频输出回调 */
  setSampleCallback(cb: AudioSampleCallback): void {
    this._onSample = cb;
  }
