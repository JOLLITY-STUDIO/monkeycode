...
import { OPENING_FRAMES_SCENE_1 } from './opening/opening-tecmo-start.ts';
import { OPENING_FRAMES_SCENE_2 } from './opening/opening-title-1.ts';
import { OPENING_FRAMES_SCENE_3 } from './opening/opening-title-2.ts';
import { OPENING_FRAMES_SCENE_4 } from './opening/opening-subtitle-1.ts';
import { OPENING_FRAMES_SCENE_5 } from './opening/opening-subtitle-2.ts';
import { OPENING_FRAMES_SCENE_6 } from './opening/opening-subtitle-3.ts';
import { OPENING_FRAMES_SCENE_7 } from './opening/opening-subtitle-4.ts';
import { OPENING_FRAMES_SCENE_8 } from './opening/opening-subtitle-5.ts';
import { OPENING_FRAMES_SCENE_9 } from './opening/opening-subtitle-6.ts';
import { OPENING_FRAMES_SCENE_10 } from './opening/opening-subtitle-7.ts';
import { OPENING_FRAMES_SCENE_11 } from './opening/opening-ending-scroll.ts';
import { OPENING_FRAMES_SCENE_12 } from './opening/opening-ending-end.ts';
