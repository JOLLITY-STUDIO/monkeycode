...
export { SKILL_TABLE, SKILL_POINTER_TABLE, SKILL_MOVE_ID_TABLE, SKILL_TRIGGER_TABLE, findSkillByMoveId, findSkillsByPlayer } from './tables/skill-table';
