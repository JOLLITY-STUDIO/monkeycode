...
// ── PRG Banks (现有本地副本, 缺失的 bank 用 0xFF 填充) ──
...
import CHR_00 from '../../chr/chr-bank-00';
import CHR_01 from '../../chr/chr-bank-01';
import CHR_02 from '../../chr/chr-bank-02';
import CHR_03 from '../../chr/chr-bank-03';
import CHR_04 from '../../chr/chr-bank-04';
import CHR_05 from '../../chr/chr-bank-05';
import CHR_06 from '../../chr/chr-bank-06';
import CHR_07 from '../../chr/chr-bank-07';
import CHR_08 from '../../chr/chr-bank-08';
import CHR_09 from '../../chr/chr-bank-09';
import CHR_10 from '../../chr/chr-bank-10';
import CHR_11 from '../../chr/chr-bank-11';
import CHR_12 from '../../chr/chr-bank-12';
import CHR_13 from '../../chr/chr-bank-13';
import CHR_14 from '../../chr/chr-bank-14';
import CHR_15 from '../../chr/chr-bank-15';
...
const PRG_COPIES: Record<number, number[]> = {
  7: [...PRG_BANK_07],
  8: [...PRG_BANK_08], 9: [...PRG_BANK_09], 10: [...PRG_BANK_10],
  17: [...PRG_BANK_17], 18: [...PRG_BANK_18], 19: [...PRG_BANK_19], 20: [...PRG_BANK_20],
  21: [...PRG_BANK_21], 23: [...PRG_BANK_23], 24: [...PRG_BANK_24], 25: [...PRG_BANK_25],
  28: [...PRG_BANK_28], 31: [...PRG_BANK_31],
};
...
/**
 * 拼装完整 PRG ROM (32 × 8192 = 256KB)。仅含本地副本的 bank, 缺失的用 0xFF。
 */
