...
import type { TeamDataDisplayState } from '../code/bank01_data-query';
import type { SpriteEntry, NameTableEntry } from '../DataStore';
import { getCharacterName, getCharacterNameCn, isGoalkeeper } from '../character-list';
import { getPlayerStatsById, codeToStamina, codeToAbility } from '../player-stats';
import { PLAYER_TEAMS } from '../team-roster';
import { SHOT_DIGITS, DRIBBLE_DIGITS, PASS_DIGITS, getSpecialMoves } from '../special-moves';
