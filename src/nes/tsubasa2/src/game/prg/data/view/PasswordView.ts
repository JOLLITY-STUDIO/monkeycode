...
import { passwordCharToTile, type PasswordDisplayState } from '../code/bank02_password';
import { PASSWORD_SPRITES } from '../password-sprites';
import type { SpriteEntry } from '../DataStore';
