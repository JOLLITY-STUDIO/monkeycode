/**
 * 密码界面 View — 读 PasswordDisplayState, 写 RamStore OAM 精灵。
 *
 ...
 *
 * 职责: 把 state.chars (0-35) 映射成 CHR tile 精灵写到 RamStore.sprites
 * (对应 NES NMI OAM DMA 传输), 光标位置 (state.charIdx) 调色板高亮。
 */
import { SceneView } from './SceneView';
import { passwordCharToTile, type PasswordDisplayState } from '../bank02_password';
