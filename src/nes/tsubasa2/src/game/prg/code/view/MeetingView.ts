 ...
 *   view (本类) → 读 state, 写 RamStore NT (菜单项字符) + OAM (光标精灵)
...
import type { TeamDataDisplayState } from '../bank01_data-query';
import type { SpriteEntry, NameTableEntry } from '../../../../core/nes-ram';
import { getCharacterName, getCharacterNameCn, isGoalkeeper } from '../../data/character-list';
import { getPlayerStatsById, codeToStamina, codeToAbility } from '../../data/player-stats';
import { PLAYER_TEAMS } from '../../data/team-roster';
import { SHOT_DIGITS, DRIBBLE_DIGITS, PASS_DIGITS, getSpecialMoves } from '../../data/special-moves';
