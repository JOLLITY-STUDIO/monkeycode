 ...
 *   view (本类) → 读 service state, 写 RamStore NT (选手名 + 等级 + 经验)
...
import type { NameTableEntry, SpriteEntry } from '../../../../core/nes-ram';
...
import type { LevelUpService, PlayerRamSlot } from '../levelup';
