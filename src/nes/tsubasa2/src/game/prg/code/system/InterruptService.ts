...
export class InterruptService {
  ...
  /** bank02 NMI 渲染执行�?(BootRouter.nmiRender, $8000-$8137) �?组合根注�?*/
  ...
  nmi(frame: number): void {
    ...
    // �?$2000/$2001/$2006/$2007 + OAM DMA + 调色板刷�?+ 滚动寄存器�?    // 翻译�? BootRouter.nmiRender() 回放 $05E8 PPU buffer �?    //   NT �?($2000-$2FFF) 直写 DataStore writeNT, 调色板区 ($3F00) 直写 paletteTable
