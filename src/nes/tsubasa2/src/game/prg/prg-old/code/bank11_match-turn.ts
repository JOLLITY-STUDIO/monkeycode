...
import { B18_DATA } from '../data/bank18-data'; // $85C2 pattern 数据源 (物理 bank 18 结构化接口)
...
export class Bank11Service {
  ...
  private fn_85C2(a: number, y: number, x: number): number {
    ...
    // $866F-$8679: bank = (mid & $20) ? $13 : $12 — mid 为 8bit y 右移 4 次, bit5 恒 0 → 恒 bank 0x12
    ...
    const src = B18_DATA; // 恒物理 bank 18 pattern 数据
