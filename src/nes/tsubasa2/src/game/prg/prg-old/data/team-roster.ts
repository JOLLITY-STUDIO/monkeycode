...
export interface TeamRoster {
  ...
  /** 阵型战术 (高4位=防守 0=Normal/1=Press/2=Counter, 低4位=阵型 0=433/1=442/2=352/3=Brazil) */
  formation?: number;
}

/** 玩家队配置 */
export const PLAYER_TEAMS: readonly TeamRoster[] = [
  {
    name: 'Sao Paulo',
...
export const CPU_TEAMS_BRAZIL: readonly TeamRoster[] = [
...
export function getCpuTeam(roundIndex: number): TeamRoster | null {
  return CPU_TEAMS_BRAZIL[roundIndex] ?? null;
}
