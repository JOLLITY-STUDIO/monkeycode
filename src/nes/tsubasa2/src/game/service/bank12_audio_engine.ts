...
} from '../data/prg/bank12_audio_tables';
...
export class Bank12AudioEngine {
  ...
  private bgmNesBase = 0;
  private bgmHeaderOffset = 0;
  ...
  /** 注入 Bank 12 SE 数据 */
  setSeBankData(data: Uint8Array): void {
  ...
  private _dispatchCmd(ch: number, blk: ChBlock, data: Uint8Array, cmdByte: number): boolean {
    ...
    switch (cmdIdx) {
      ...
      // $E6, $E7: NOP
      case 0x06: case 0x07: return true;
      // $E8 → JUMP
      case 0x08: {
        const lo = read();
        const hi = read();
      ...
      // $F0, $F1: NOP
      case 0x10: case 0x11: return true;
      // $F2 → STOP ALL: NOP
      ...
      // $F5-$F8: NOP
      case 0x15: case 0x16: case 0x17: case 0x18: return true;
      // $F9 → DMC init A
      case 0x19: {
