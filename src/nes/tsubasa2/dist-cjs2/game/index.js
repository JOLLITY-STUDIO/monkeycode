...
class Tsubasa2 {
    constructor() {
        ...
        this.router.getController(index_3.SceneId.Scene0).attachAudio(this.audio);
        // Ƭͷ���У�OpeningScene����Ƶע�루���� tecmo_logo �� BGM 0x01��
        this.router.getController(index_3.SceneId.Opening).attachAudio(this.audio);
        ...
        this.router.getController(index_3.SceneId.Scene0).attachNtStreamLoader(this.ntStreamLoader);
        this.router.getController(index_3.SceneId.Scene0).attachSceneStateMachine(this.sceneStateMachine);
        // Ӳ����ʼ�� + �жϹ���
    ...
    boot(target) {
        ...
        this.router.changeScene(index_3.SceneId.Opening);
