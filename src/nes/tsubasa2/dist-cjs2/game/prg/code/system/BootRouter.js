...
exports.BootRouter = exports.SceneId = exports.MATCH_START_SCENE_ID = exports.MEETING_SCENE_ID = exports.TITLE_MENU_SCENE_ID = exports.OPENING_SCENE_ID = void 0;
const index_1 = require("../scene/index");
const SceneIds_1 = require("../scene/SceneIds");
/** 场景号枚举 (0-23 + Opening=100 + TitleMenu=200) — 定义见 scene/SceneIds.ts */
var SceneIds_2 = require("../scene/SceneIds");
Object.defineProperty(exports, "OPENING_SCENE_ID", { enumerable: true, get: function () { return SceneIds_2.OPENING_SCENE_ID; } });
Object.defineProperty(exports, "TITLE_MENU_SCENE_ID", { enumerable: true, get: function () { return SceneIds_2.TITLE_MENU_SCENE_ID; } });
Object.defineProperty(exports, "MEETING_SCENE_ID", { enumerable: true, get: function () { return SceneIds_2.MEETING_SCENE_ID; } });
Object.defineProperty(exports, "MATCH_START_SCENE_ID", { enumerable: true, get: function () { return SceneIds_2.MATCH_START_SCENE_ID; } });
Object.defineProperty(exports, "SceneId", { enumerable: true, get: function () { return SceneIds_2.SceneId; } });
/** Scene0-23 + Opening + TitleMenu 控制器类列表 (顺序对应 sceneId), 用于自动统一 register */
const SCENE_CONTROLLERS = [
    index_1.Scene0Controller,
    index_1.Scene1Controller, index_1.Scene2Controller, index_1.Scene3Controller, index_1.Scene4Controller,
    index_1.Scene5Controller, index_1.Scene6Controller, index_1.Scene7Controller, index_1.Scene8Controller,
    index_1.Scene9Controller, index_1.Scene10Controller, index_1.Scene11Controller, index_1.Scene12Controller,
    index_1.Scene13Controller,
    index_1.Scene14Controller, index_1.Scene15Controller, index_1.Scene16Controller, index_1.Scene17Controller,
    index_1.Scene18Controller, index_1.Scene19Controller, index_1.Scene20Controller, index_1.Scene21Controller,
...
class BootRouter {
    ...
    getController(sceneId) {
        ...
        if (!c)
            throw new Error(`BootRouter.getController: sceneId=${sceneId} 未注册`);
        return c;
    }
    /**
