...
class MatchStartSceneController extends SceneController_1.SceneController {
    constructor() {
        super(...arguments);
        this.sceneId = SceneIds_1.MATCH_START_SCENE_ID;
    ...
    attachMatchTurn(turn) {
        this.matchTurn = turn;
    }
    onEnter() {
        this.store.writeByte(0x0001, SceneIds_1.MATCH_START_SCENE_ID & 0xff);
        this.matchStarted = false;
    }
    onUpdate(_frame) {
        ...
        if (this.matchEngine && this.input.isPressed(1, 1 /* Button.A */)) {
