...
exports.MatchEventService = exports.MatchEventType = void 0;
const match_event_table_1 = require("../../data/tables/match-event-table");
/** 比赛事件类型 */
var MatchEventType;
...
class MatchEventService {
     ...
     */
    startEvent(req) {
        const entry = (0, match_event_table_1.findEventById)(req.eventId);
    ...
    findEventPointer(eventId) {
        const entry = match_event_table_1.BANK20_EVENT_POINTER_TABLE.find(p => p.eventId === eventId);
        return entry ? entry.target : 0;
    }
    /** 导出表供外部访问 */
    get table() { return match_event_table_1.BANK20_EVENT_TABLE; }
}
