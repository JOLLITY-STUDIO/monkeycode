...
const OamManager_1 = require("../../core/OamManager");
// ── 内存 KV ──
/** 语义化内存键名 */
exports.RAM_KEYS = {
    // 游戏状态
...
class DataStore {
    ...
    read(key) {
        var _a;
        return (_a = this.ram.get(key)) !== null && _a !== void 0 ? _a : 0;
    }
    write(key, value) {
    ...
    read16(keyLo, keyHi) {
        var _a, _b;
        const lo = (_a = this.ram.get(keyLo)) !== null && _a !== void 0 ? _a : 0;
        const hi = (_b = this.ram.get(keyHi)) !== null && _b !== void 0 ? _b : 0;
        return (hi << 8) | lo;
    }
    // ── 调色板操作 ──
    /** 写入单组 BG 调色板 */
