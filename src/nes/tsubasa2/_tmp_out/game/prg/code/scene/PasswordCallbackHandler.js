...
exports.PasswordCallbackHandler = void 0;
...
class PasswordCallbackHandler {
    ...
    ppuFill(baseAddr, fill, rows, cols) {
     ...
     * @param cols 列数 (X 寄存器)
     */
    ppuFillByte(fill, baseAddr, rows, cols) {
...
exports.PasswordCallbackHandler = PasswordCallbackHandler;
/** 假名网格 CHR tile 集合长度 (100 字节, asm $58-$70) */
PasswordCallbackHandler.GRID_TILE_COUNT = 100;
exports.default = PasswordCallbackHandler;
