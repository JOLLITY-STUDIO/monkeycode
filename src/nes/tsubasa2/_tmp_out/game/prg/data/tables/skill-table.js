...
exports.CHARACTER_SKILL_TABLE = exports.SKILL_SLOT_INDEX = exports.STAR_SKILL_PTR_TABLE = void 0;
exports.getMovePtr = getMovePtr;
 ...
 */
function getMovePtr(moveId) {
    if (moveId < 0 || moveId >= exports.STAR_SKILL_PTR_TABLE.length) {
        return 0xffff;
    }
    return exports.STAR_SKILL_PTR_TABLE[moveId];
}
/**
 ...
 * 未实现时返回 null。
 */
function getCharacterSkills(charIndex) {
    if (charIndex < 0 || charIndex >= exports.CHARACTER_SKILL_TABLE.length) {
        return null;
    }
    return exports.CHARACTER_SKILL_TABLE[charIndex];
}
