...
exports.SPRITE_FILL_88D2 = exports.PALETTE_ANIM_87B3 = exports.TEXT_BUFFER_TEMPLATE_978B = exports.SCENE_SCRIPT_8442 = exports.SCENE_SCRIPT_8420 = exports.SCENE_SCRIPT_83FE = exports.SCENE_SCRIPT_83DC = exports.SCENE_FLAG_83BA = exports.SCENE_NEXT_8398 = exports.FRAME_WAIT_TABLE = exports.PAL_HELPER_TABLE = exports.LONG_OPCODE_TABLE = exports.WAIT_FRAME_TABLE = void 0;
/** 等待帧表 $8AE6 — 脚本等待控制码 ($D8-$DF) 对应的帧延迟计数 */
exports.WAIT_FRAME_TABLE = [
    1, 10, 20, 40, 60, 80, 120, 240,
];
/** 长指令表 $8545 — 24 个长指令处理器入口 (16-bit LE, opcode $E8-$FF) */
exports.LONG_OPCODE_TABLE = [
...
exports.TEXT_BUFFER_TEMPLATE_978B = [
    0x80, 0x01, 0x00, 0x00, 0x00, 0x30, 0x00, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
];
/** 小数据表 $87B3 (淡入淡出动画调色板序列) */
exports.PALETTE_ANIM_87B3 = [0x84, 0x30, 0x20, 0x10, 0x0F];
/** 精灵初始化数据 $88D2 (影子 OAM 填充模板) */
exports.SPRITE_FILL_88D2 = [0xA0, 0x90, 0x18, 0x48, 0xC9, 0xC8, 0xA9, 0x94];
