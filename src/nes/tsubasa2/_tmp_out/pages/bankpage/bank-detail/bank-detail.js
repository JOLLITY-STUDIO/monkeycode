...
const bank02_analysis_1 = __importDefault(require("./bank02_analysis"));
const bank12_analysis_1 = __importDefault(require("./bank12_analysis"));
const bank27_analysis_1 = __importDefault(require("./bank27_analysis"));
const bank30_analysis_1 = __importDefault(require("./bank30_analysis"));
const bank31_analysis_1 = __importDefault(require("./bank31_analysis"));
const bank12_audio_player_1 = require("./bank12-audio-player");
const bank02_data_schema_1 = require("./bank02_data_schema");
...
Page({
    data: {
        ...
        b27DataTables: [],
        b27Deps: null,
        b27Architecture: null,
        b27SelectedFunc: null,
        // ── Bank 12 音频引擎 ──
        b12Subroutines: [],
        b12DataTables: [],
        b12AudioCommands: [],
    ...
    _loadBank27Analysis() {
        const analysis = bank27_analysis_1.default;
        const subs = analysis.subroutines || [];
        const tables = analysis.dataTables || [];
        const deps = {
            dependsOn: (analysis.deps?.dependsOn || []).map((d) => d.bank + ': ' + d.what),
            usedBy: (analysis.deps?.usedBy || []).map((u) => u.bank + ': ' + u.what),
        };
        this.setData({
            b27Subroutines: subs,
    ...
    _loadBank12Analysis() {
        ...
        const extApi = (analysis.externalInterface?.methods || []).map((m) => ({
