...
exports.Scene0Controller = void 0;
/**
...
var Scene0Phase;
(function (Scene0Phase) {
    /** $84C1-$84C8: $9A0D 渐显（若 $004A>0）+ 等 16 帧 */
    Scene0Phase[Scene0Phase["FadeInAndWait16"] = 0] = "FadeInAndWait16";
    /** $84C9-$84D6: 0x30 次循环 {等 1 帧; OAM 下漂 +1} */
    Scene0Phase[Scene0Phase["OamDrift"] = 1] = "OamDrift";
    /** 场景 3 NT 数据逐行写入渲染缓冲（原版 $8AF7 同步展开；H5 分帧） */
    Scene0Phase[Scene0Phase["LoadScene3Nt"] = 2] = "LoadScene3Nt";
    /** $84F4-$84F8: 等 4 帧 */
    Scene0Phase[Scene0Phase["Wait4"] = 3] = "Wait4";
    /** $84FF-$8513: 滚动循环 {等 1 帧; INC $0079; DEC $007C×2; $0044-=2; until <3} */
    Scene0Phase[Scene0Phase["Scroll"] = 4] = "Scroll";
    /** $8520-$8527: 等 240 + 60 帧 */
    Scene0Phase[Scene0Phase["Hold"] = 5] = "Hold";
    /** $8538: $99F0 渐隐 */
    Scene0Phase[Scene0Phase["FadeOut"] = 6] = "FadeOut";
    /** 已返回下一场景号（本控制器不再被调度） */
    Scene0Phase[Scene0Phase["Done"] = 7] = "Done";
})(Scene0Phase || (Scene0Phase = {}));
class Scene0Controller extends SceneController_1.SceneController {
    ...
    onEnter() {
        ...
        (_a = this.audio) === null || _a === void 0 ? void 0 : _a.playBgm(0x01);
    }
    onUpdate(frame) {
        void frame;
...
exports.Scene0Controller = Scene0Controller;
