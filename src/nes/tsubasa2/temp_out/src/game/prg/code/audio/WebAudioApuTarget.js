...
class WebAudioApuTarget {
    ...
    async init() {
        var _a;
        const Ctor = (_a = globalThis.AudioContext) !== null && _a !== void 0 ? _a : globalThis.webkitAudioContext;
        if (!Ctor) {
    ...
    suspend() {
        var _a;
        (_a = this.ctx) === null || _a === void 0 ? void 0 : _a.suspend();
    }
    /** 恢复音频 */
    async resume() {
        var _a;
        await ((_a = this.ctx) === null || _a === void 0 ? void 0 : _a.resume());
    }
    /** 销毁 */
    dispose() {
        var _a, _b, _c, _d, _e;
        (_a = this.pulse1) === null || _a === void 0 ? void 0 : _a.oscillator.stop();
        (_b = this.pulse2) === null || _b === void 0 ? void 0 : _b.oscillator.stop();
        (_c = this.triangle) === null || _c === void 0 ? void 0 : _c.oscillator.stop();
        (_d = this.noiseSrc) === null || _d === void 0 ? void 0 : _d.stop();
        (_e = this.ctx) === null || _e === void 0 ? void 0 : _e.close();
        this.ctx = null;
    }
}
