...
class BootRouter {
    constructor(store, scene0) {
        ...
        this.register(scene0 !== null && scene0 !== void 0 ? scene0 : new SceneStubController(0 /* SceneId.Scene0 */));
    ...
    getController(sceneId) {
        var _a;
        return (_a = this.scenes.get(sceneId)) !== null && _a !== void 0 ? _a : new SceneStubController(sceneId);
    }
    /**
    ...
    changeScene(sceneId) {
        ...
        this.current = next;
        next === null || next === void 0 ? void 0 : next.onEnter();
    }
    /** 每帧更新（NMI 游戏逻辑路径 $C421 语义）；处理场景返回的下一个场景号 */
    update(frame) {
        var _a;
        const next = (_a = this.current) === null || _a === void 0 ? void 0 : _a.onUpdate(frame);
        if (next !== undefined) {
    ...
    render() {
        var _a;
        (_a = this.current) === null || _a === void 0 ? void 0 : _a.onRender();
    }
    /** 当前场景号 */
    get sceneId() {
