...
class Tsubasa2 {
    constructor() {
        ...
        // ����������
        const opening = new index_2.OpeningSceneController(this.store, this.input);
        const title = new index_2.TitleSceneController(this.store, this.input);
        const password = new index_2.PasswordSceneController(this.store, this.input);
        const result = new index_2.ResultSceneController(this.store, this.input);
        const story = new index_2.StorySceneController(this.store, this.input);
        // ����ű���V0.4 ���룩
        ...
        // ·�ɣ�ע��ȫ������
        this.router = new index_2.BootRouter(this.store, opening);
    ...
    boot() {
        ...
        this.router.changeScene(0 /* SceneId.Opening */);
    }
    /**
