...
exports.ShowcaseView = exports.SHOWCASE_CHR_BANK = void 0;
/**
 * 演出画面 View — 球员射门特写 + 名字横幅 + 球
 *
 * 对应 Bank31 $E93D 演出精灵展开 + Bank26 技能演出渲染。
 * 读 Bank26ShowcaseExecutor 的 DisplayState, 写 OAM 精灵 (DataStore.oam)。
 *
...
exports.SHOWCASE_CHR_BANK = 7;
/** 球 tile (CHR bank 7 圆形球) */
const BALL_TILE = 0x60;
class ShowcaseView extends SceneView_1.SceneView {
    constructor() {
        super(...arguments);
    ...
    render(state) {
        ...
        for (let r = 0; r < block.rows; r++) {
            for (let c = 0; c < block.perRow; c++) {
                ...
                oam.setBank(slot, exports.SHOWCASE_CHR_BANK);
...
exports.ShowcaseView = ShowcaseView;
