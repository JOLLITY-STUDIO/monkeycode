...
exports.GK_STATS_RAW = exports.GK_STAT_FIELDS = void 0;
exports.getGkStatsRaw = getGkStatsRaw;
exports.getGkStats = getGkStats;
exports.GK_STAT_FIELDS = [
    'stamina', // 0
    'pass', // 1
    'catching', // 2
    'punching', // 3
...
function getGkStatsRaw(gkIndex) {
    return exports.GK_STATS_RAW[gkIndex] ?? new Array(8).fill(0);
}
/** 按 gkIndex 获取结构化能力值对象 */
function getGkStats(gkIndex) {
    const raw = getGkStatsRaw(gkIndex);
    const obj = {};
    for (let i = 0; i < exports.GK_STAT_FIELDS.length; i++) {
        obj[exports.GK_STAT_FIELDS[i]] = raw[i] ?? 0;
    }
    return obj;
}
