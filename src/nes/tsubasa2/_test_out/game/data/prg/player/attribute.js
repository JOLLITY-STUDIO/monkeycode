...
exports.ABILITY_ROM_ADDR_MAP = exports.PLAYER_ABILITY_ROM_ADDR = exports.GK_ABILITY_SIZE = exports.PLAYER_ABILITY_SIZE = exports.PLAYER_STATS_FIELD = exports.CPU_TEAM_STATS_COUNT = exports.CPU_TEAM_STATS_BASE = exports.PLAYER_STATS_STRIDE = exports.PLAYER_STATS_COUNT = exports.PLAYER_STATS_BASE = void 0;
// ═══════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════
/** 我方球员属性区起始地址 */
exports.PLAYER_STATS_BASE = 0x0300;
/** 我方球员数 (含 2 名替补 GK, 共 21 人) */
exports.PLAYER_STATS_COUNT = 21;
/** 单球员属性记录大小 (字节) */
exports.PLAYER_STATS_STRIDE = 0x0C;
/** CPU 队属性区起始地址 */
exports.CPU_TEAM_STATS_BASE = 0x0384;
/** CPU 队球员数 (11 人) */
exports.CPU_TEAM_STATS_COUNT = 11;
/** 属性记录内字段偏移 */
exports.PLAYER_STATS_FIELD = {
...
// ═══════════════════════════════════════════════════════════════
/** 普通球员能力值块大小 (字节) */
exports.PLAYER_ABILITY_SIZE = 23;
/** 门将能力值块大小 (字节) */
exports.GK_ABILITY_SIZE = 8;
/** 角色能力值 ROM 地址表 (指南提供) */
exports.PLAYER_ABILITY_ROM_ADDR = [
...
/** 角色名 → 能力值 ROM 地址 (快速查找) */
exports.ABILITY_ROM_ADDR_MAP = new Map(exports.PLAYER_ABILITY_ROM_ADDR.map(p => [p.name, p.addr]));
