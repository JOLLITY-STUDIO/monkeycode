...
const prg_bank_03_1 = __importDefault(require("../prg-bank-03"));
const prg_bank_04_1 = __importDefault(require("../prg-bank-04"));
const prg_bank_05_1 = __importDefault(require("../prg-bank-05"));
const prg_bank_06_1 = __importDefault(require("../prg-bank-06"));
...
const chr_bank_00_1 = __importDefault(require("../ppu/tile/chr/chr-bank-00"));
const chr_bank_01_1 = __importDefault(require("../ppu/tile/chr/chr-bank-01"));
const chr_bank_02_1 = __importDefault(require("../ppu/tile/chr/chr-bank-02"));
const chr_bank_03_1 = __importDefault(require("../ppu/tile/chr/chr-bank-03"));
const chr_bank_04_1 = __importDefault(require("../ppu/tile/chr/chr-bank-04"));
const chr_bank_05_1 = __importDefault(require("../ppu/tile/chr/chr-bank-05"));
const chr_bank_06_1 = __importDefault(require("../ppu/tile/chr/chr-bank-06"));
const chr_bank_07_1 = __importDefault(require("../ppu/tile/chr/chr-bank-07"));
const chr_bank_08_1 = __importDefault(require("../ppu/tile/chr/chr-bank-08"));
const chr_bank_09_1 = __importDefault(require("../ppu/tile/chr/chr-bank-09"));
const chr_bank_10_1 = __importDefault(require("../ppu/tile/chr/chr-bank-10"));
const chr_bank_11_1 = __importDefault(require("../ppu/tile/chr/chr-bank-11"));
const chr_bank_12_1 = __importDefault(require("../ppu/tile/chr/chr-bank-12"));
const chr_bank_13_1 = __importDefault(require("../ppu/tile/chr/chr-bank-13"));
const chr_bank_14_1 = __importDefault(require("../ppu/tile/chr/chr-bank-14"));
const chr_bank_15_1 = __importDefault(require("../ppu/tile/chr/chr-bank-15"));
exports.PRG_BANK_SIZE = 0x2000; // 8192
exports.CHR_BANK_SIZE = 0x2000; // 8192
/** 本地 PRG bank 副本表（bank 数据为 readonly number[]，拼装时转 number[]） */
const PRG_COPIES = {
    0: [...prg_bank_00_1.default], 1: [...prg_bank_01_1.default], 2: [...prg_bank_02_1.default], 3: [...prg_bank_03_1.default],
    4: [...prg_bank_04_1.default], 5: [...prg_bank_05_1.default], 6: [...prg_bank_06_1.default], 7: [...prg_bank_07_1.default],
