...
exports.CHARACTER_SPECIAL_MOVES = exports.PASS_DIGITS = exports.DRIBBLE_DIGITS = exports.SHOT_DIGITS = void 0;
exports.getSpecialMoves = getSpecialMoves;
exports.getSpecialMove = getSpecialMove;
/** 射门技能 ID→名称 */
exports.SHOT_DIGITS = new Map([
...
/** 按角色 ID 查找必杀技 */
function getSpecialMoves(id) {
    return exports.CHARACTER_SPECIAL_MOVES.find(s => s.id === id) ?? null;
}
/** 按角色 ID 获取某项技能的 [数量上限, 技能ID] */
function getSpecialMove(id, field) {
