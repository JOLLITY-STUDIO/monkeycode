...
exports.MODE_BLOCK_PTRS = void 0;
exports.applyModeBlocks = applyModeBlocks;
/** bank6 $BB40 模式指针表 (mode 0-3 有有效块链, mode 4+ 原版即无数据) */
exports.MODE_BLOCK_PTRS = [
...
function applyModeBlocks(store, ptr, readByte, chrBank = 0) {
    ...
    for (let guard = 0; guard < 64; guard++) {
        ...
        if (vramAddr < 0x2000 || vramAddr > 0x2FFF)
            break;
        ...
        const ntSelect = vramAddr < 0x2400 ? 0 : 1;
