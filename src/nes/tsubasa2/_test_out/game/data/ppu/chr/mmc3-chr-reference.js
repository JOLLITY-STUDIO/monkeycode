...
exports.Mmc3ChrReference = exports.MMC3_CMD_PRG_PAGE2 = exports.MMC3_CMD_PRG_PAGE1 = exports.MMC3_CMD_1K_1C00 = exports.MMC3_CMD_1K_1800 = exports.MMC3_CMD_1K_1400 = exports.MMC3_CMD_1K_1000 = exports.MMC3_CMD_2_1K_0800 = exports.MMC3_CMD_2_1K_0000 = void 0;
exports.fromEmuChrBanks = fromEmuChrBanks;
const chr_slot_mapper_1 = require("./chr-slot-mapper");
exports.MMC3_CMD_2_1K_0000 = 0;
exports.MMC3_CMD_2_1K_0800 = 1;
exports.MMC3_CMD_1K_1000 = 2;
exports.MMC3_CMD_1K_1400 = 3;
exports.MMC3_CMD_1K_1800 = 4;
exports.MMC3_CMD_1K_1C00 = 5;
exports.MMC3_CMD_PRG_PAGE1 = 6;
exports.MMC3_CMD_PRG_PAGE2 = 7;
/**
 * MMC3 CHR bank 参考状态机 (纯函数式, 无硬件依赖)。
 * 仅用于校验: 把模拟器 trace 的 $8000/$8001 写序列喂进来,
 * 输出与模拟器完全一致的 chrBanks 状态。
 */
class Mmc3ChrReference {
    constructor() {
        this.command = 0;
    ...
    executeCommand(cmd, arg) {
        ...
        switch (cmd) {
            case exports.MMC3_CMD_2_1K_0000:
                if (!swap) {
                ...
                break;
            case exports.MMC3_CMD_2_1K_0800:
                if (!swap) {
                ...
                break;
            case exports.MMC3_CMD_1K_1000:
                if (!swap)
                    this.chrBanks[4] = arg & 0xff;
                else
                    this.chrBanks[0] = arg & 0xff;
                break;
            case exports.MMC3_CMD_1K_1400:
                if (!swap)
                    this.chrBanks[5] = arg & 0xff;
                else
                    this.chrBanks[1] = arg & 0xff;
                break;
            case exports.MMC3_CMD_1K_1800:
                if (!swap)
                    this.chrBanks[6] = arg & 0xff;
                else
                    this.chrBanks[2] = arg & 0xff;
                break;
            case exports.MMC3_CMD_1K_1C00:
                if (!swap)
                    this.chrBanks[7] = arg & 0xff;
                else
                    this.chrBanks[3] = arg & 0xff;
                break;
            case exports.MMC3_CMD_PRG_PAGE1:
            case exports.MMC3_CMD_PRG_PAGE2:
                // PRG 映射 — H5 不启用, 记录即可
                break;
        }
    }
    ...
    matches(emuChrBanks) {
        if (emuChrBanks.length !== 8)
            return false;
        for (let i = 0; i < 8; i++) {
            if (this.chrBanks[i] !== (emuChrBanks[i] & 0xff))
                return false;
        }
        return true;
    }
     ...
     */
    mapToH5(tile, patternTable) {
        return (0, chr_slot_mapper_1.mapChrSlotToH5)(this.chrBanks, tile, patternTable);
    }
}
exports.Mmc3ChrReference = Mmc3ChrReference;
/** 便捷工厂: 从模拟器 chrBanks 构建参考对象 (校验时对比用) */
function fromEmuChrBanks(emu) {
    const ref = new Mmc3ChrReference();
    for (let i = 0; i < 8; i++)
        ref.chrBanks[i] = emu[i] & 0xff;
    return ref;
}
