...
exports.SCRIPT_CATEGORIES = exports.SUB_DISPATCH_NAMES = exports.LONG_INSTRS = exports.WAIT_FRAMES = exports.InstrType = void 0;
exports.getScriptBank = getScriptBank;
exports.getScriptBaseOffset = getScriptBaseOffset;
// ── 指令类型 ──
var InstrType;
(function (InstrType) {
    InstrType["TEXT"] = "TEXT";
    InstrType["TEXT_CTRL"] = "TEXT_CTRL";
    InstrType["WAIT"] = "WAIT";
    InstrType["LONG_INSTR"] = "LONG_INSTR";
...
function getScriptBaseOffset(scriptId) {
    if (scriptId < 0x10)
        return scriptId * 2;
    if (scriptId < 0x20)
        return (scriptId - 0x10) * 2;
    if (scriptId < 0x60)
        return (scriptId - 0x20) * 2;
    return (scriptId - 0x60) * 2;
}
// ── 脚本分类 (基于 bank 和 ID 范围) ──
exports.SCRIPT_CATEGORIES = [
