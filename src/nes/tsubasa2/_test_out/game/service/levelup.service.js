...
exports.LevelUpService = exports.LEVELUP_RULES = void 0;
...
class LevelUpService {
     ...
     */
    maxOut(playerIndex) {
        this.setLevel(playerIndex, exports.LEVELUP_RULES.MAX_LEVEL);
        this.setExp(playerIndex, 0xFFFF);
        this.setGuts(playerIndex, exports.LEVELUP_RULES.MAX_ALL_STATS);
    }
    // ── 球员槽读取 (完整结构) ──
    /** 读取球员完整 RAM 槽 */
    getPlayerSlot(playerIndex) {
        return {
