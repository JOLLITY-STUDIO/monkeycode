...
(function (ChannelType) {
    ChannelType[ChannelType["OFF"] = 0] = "OFF";
    ChannelType[ChannelType["SQUARE_TRI"] = 1] = "SQUARE_TRI";
    ChannelType[ChannelType["SPECIAL"] = 2] = "SPECIAL";
...
// Bank12AudioService
// ═══════════════════════════════════════════════════════════════
class Bank12AudioService {
    constructor(_store, _audioOut) {
     ...
     */
    _loadBgm(bgmId) {
        const offset = exports.BGM_DATA_MAP[bgmId];
        ...
        const tracks = [[], [], [], []]; // SQ1, SQ2, TRI, NOISE
        let chCount = 0;
        ...
        this._engine.load(tracks[0], tracks[1], tracks[2], tracks[3], Array.from(bank), 0xA000, offset);
        this._engine.start();
        return true;
    }
    /** 停止所有播放 */
...
exports.Bank12AudioService = Bank12AudioService;
