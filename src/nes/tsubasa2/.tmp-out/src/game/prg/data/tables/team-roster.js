 ...
 */
import { CPU_ROSTER_PRG_BYTES, PLAYER_ROSTER_PRG_BYTES, CPU_ROSTER_TACTIC_BYTES, ANCHOR_VERIFIED_TEAMS, } from './roster-prg-bytes';
...
export const TEAM_ROSTER_TABLE = TEAM_META.map(buildTeam);
/** 按 ID 找队伍 */
...
/** 按关号找该关对手 (第一支) */
export function findByEncounterLevel(level) {
    for (const t of TEAM_ROSTER_TABLE) {
...
export const TEAM_TABLE = TEAM_ROSTER_TABLE;
