...
const HAIR_TEMPLATES = PLAYER_HAIR_TABLE;
/** PLAYER_COLOR_TABLE 查表: 球员色 by ID */
const COLOR_BY_ID = new Map();
for (const c of PLAYER_COLOR_TABLE)
 ...
 */
export const PLAYER_TILE_TABLE = PLAYER_TABLE.map((p, i) => {
...
/** 按球员 ID 查 tile 桥接 */
export function findPlayerTilesById(playerId) {
