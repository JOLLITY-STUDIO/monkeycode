 ...
 */
import { LEVEL_UP_TABLE as LEVEL_UP_TABLE_EXTRACTED } from './levelup-data';
/** 升级表（已从真 ROM 提取） */
export const LEVEL_UP_TABLE = LEVEL_UP_TABLE_EXTRACTED;
/** 按累计经验查询等级 */
export function findLevelByExp(exp) {
...
/** 按等级查询该等级 entry */
export function findLevelById(level) {
    for (const e of LEVEL_UP_TABLE) {
