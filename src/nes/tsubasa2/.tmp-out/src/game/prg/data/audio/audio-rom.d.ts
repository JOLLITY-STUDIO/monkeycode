 ...
 */
export declare function getApePeriod(idx: number): number;
/** tick 时值查询（替代旧 readBank12Byte(0x8725 + idx)） */
export declare function getTickDuration(idx: number): number;
/** 命令句柄（替代旧 readBank12U16(0x84DA + idx*2)） */
export declare function getCommandHandler(idx: number): number;
/** 旧 BGM/SE request ID 范围常量 (测试残留兼容) */
export declare const SONG_REQUEST_IDS: {
    readonly BGM_LOW: 3;
    readonly BGM_HIGH: 50;
    readonly SE_LOW: 50;
    readonly SE_HIGH: 111;
    readonly SE_EXT_HIGH: 111;
};
export declare class AudioRom {
