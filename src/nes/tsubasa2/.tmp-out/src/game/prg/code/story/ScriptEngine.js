import { ScriptOpcode, OPCODE_DIRECT_MAX, OPCODE_INDIRECT_BASE, classifyOpcode, getHandler, } from './ScriptOpcodes';
/**
 * ScriptEngine 调度器
 *
 ...
 * 范围检查常量（暴露供测试/调试用）。
 */
ScriptEngine.DIRECT_MAX = OPCODE_DIRECT_MAX;
ScriptEngine.INDIRECT_BASE = OPCODE_INDIRECT_BASE;
