import { SKILL_TABLE, SKILL_POINTER_TABLE, SKILL_MOVE_ID_TABLE, SKILL_TRIGGER_TABLE, findSkillByMoveId, findSkillsByPlayer, } from '../../data/tables/skill-table';
export class SkillService {
    ...
    checkSkillTrigger(moveId) {
        ...
        for (let i = 0; i < 4 && i < SKILL_TRIGGER_TABLE.length; i++) {
            if (SKILL_TRIGGER_TABLE[i] === masked)
                return true;
        }
        return false;
    }
