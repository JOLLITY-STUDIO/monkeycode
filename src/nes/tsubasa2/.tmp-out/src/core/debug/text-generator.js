 ...
 *        ! = ptTile 不存在（无 CHR 数据）
 */
export function generateNTDataText(nes, frameCount) {
    const ppu = nes.ppu;
    const lines = [];
 ...
 */
export function generatePaletteDataText(nes, frameCount) {
    const ppu = nes.ppu;
    const lines = [];
    lines.push(`══════════════════════════════════════════════`);
 ...
 */
export function generateSPOAMDataText(nes) {
    const ppu = nes.ppu;
 ...
 *        ! = ptTile 不存在（无 CHR 数据）
 */
export function generateSPTDataText(nes) {
    const ppu = nes.ppu;
    const lines = [];
    const COL_HEADER = 'Row ';
