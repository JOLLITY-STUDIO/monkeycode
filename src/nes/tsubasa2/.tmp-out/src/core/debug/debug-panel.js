...
import { generateNTDataText, generateSPOAMDataText, generateSPTDataText, } from './text-generator';
...
export class DebugPanel {
    constructor(page) {
        this.page = page;
        this.debugCanvas = new DebugCanvasManager();
        this.exportCanvas = new DebugCanvasManager();
        this.sprExportData = {};
