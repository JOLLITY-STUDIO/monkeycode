// temp: disasm bank0 around $8807 (JSR $A212 caller) to find scene dispatch loop
const fs = require('fs');
...
// find $8807 context: disasm backward from $8807 to find loop entry, forward 100
console.log('===== bank0 $87A0-$8860 =====');
console.log(disasm(bank, 0x7A0, 0xC0));
