// bank0 例程第一批：wait/coop/loader/BCD
const fs = require('fs');
...
disasm(0x9FA8, 0x9FC8, 'bank0 $9FA8 (wait)');
disasm(0x9F89, 0x9FA8, 'bank0 $9F89-$9FA7 (coop flag set/wait)');
disasm(0x9F69, 0x9F89, 'bank0 $9F69 (generic table loader)');
disasm(0x9E7C, 0x9ED0, 'bank0 $9E7C (BCD convert)');
disasm(0x9E36, 0x9E7C, 'bank0 $9E36 (div10)');
disasm(0x8AF7, 0x8B30, 'bank0 $8AF7 (scene data loader 2)');
disasm(0x8920, 0x8960, 'bank0 $8920 (load scene data)');
disasm(0x890C, 0x8920, 'bank0 $890C');
