// temp: disasm bank00 main loop (timer slots) + wait helpers
const fs = require('fs');
...
console.log('===== bank00 main loop $9EED-$9F70 =====');
console.log(disasm(bank0, 0x1EED, 135));
console.log('\n===== bank00 wait helpers $9F69-$9FC0 =====');
console.log(disasm(bank0, 0x1F69, 100));
