// scene15 $A651-$A69D + scene16 $A69D-$A77B + $A72C/$A767 + scene19 $A78E-$A7BE + 数据 $A677
const fs = require('fs');
...
disasm(0xA651, 0xA72C, 'scene15 $A651-$A72B');
disasm(0xA72C, 0xA77B, 'helpers $A72C-$A77A (sprite move / copy)');
disasm(0xA78E, 0xA7BE, 'scene19 $A78E-$A7BD');
