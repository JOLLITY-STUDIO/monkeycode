// scene1 $A55A-$A57C + scene23 $A7FB-$A855 精确反汇编
const fs = require('fs');
const rom = fs.readFileSync('docs/roms/Captain Tsubasa II - Super Striker (Japan).nes');
const prg = rom.slice(16);
const b2 = (cpu) => cpu - 0xa000 + 0x4000;
console.log('ROM size:', rom.length, 'PRG banks:', rom.length / 0x4000);
...
disasm(0xA55A, 0xA57C, b2, 'bank2 scene1 $A55A-$A57B (math tool)');
disasm(0xA7FB, 0xA855, b2, 'bank2 scene23 $A7FB-$A854');
disasm(0xA855, 0xA86E, b2, 'bank2 $A855-$A86D (scene entry A)');
