// 反汇编 bank02 $A460-$A4F0 看真 dispatcher
const fs = require('fs');
...
console.log('===== bank02 dispatcher $A460-$A4F0 =====');
console.log(disasm(bank2, 0x460, 145));
console.log('\n===== bank02 scenes $A4F0-$A55A (Scene0/1/2 候选) =====');
console.log(disasm(bank2, 0x4F0, 110));
console.log('\n===== bank02 scenes $A55A-$A5C0 (Scene1-2 候选) =====');
console.log(disasm(bank2, 0x55A, 100));
