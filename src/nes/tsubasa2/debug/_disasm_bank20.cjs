// temp: disasm bank20 scene dispatcher around runtime $89EA
const fs = require('fs');
...
// disasm bank20 from runtime $89C0 to $8A40 (dispatcher area)
console.log('===== bank20 $89C0-$8A40 =====');
console.log(disasm(bank, 0x9C0, 130));
