// temp: disasm bank0 main scene loop $84D7/$84E7 + script engine entry
const fs = require('fs');
...
console.log('===== bank0 $84C0-$8500 (main scene loop) =====');
console.log(disasm(bank, 0x4C0, 0x40));
console.log('\n===== bank0 $8790-$87B8 (script setup) =====');
console.log(disasm(bank, 0x790, 0x28));
