...
exports.LevelUpUiService = void 0;
...
class LevelUpUiService {
     ...
     */
    render(input) {
        const lv = (0, levelup_table_1.findLevelByExp)(input.exp);
        const entry = (0, levelup_table_1.findLevelById)(lv);
        const nextLv = lv < 30 ? (0, levelup_table_1.findLevelById)(lv + 1) : null;
...
exports.LevelUpUiService = LevelUpUiService;
/** 静态：6 项能力名常量 */
