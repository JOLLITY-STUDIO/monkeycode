...
exports.PpuTransferService = void 0;
...
class PpuTransferService {
    ...
    commitSprite4(data) {
        if (data.length < 4)
            return;
        (0, RenderQueues_1.appendNtBuffer)(this.store.renderQueue, {
            vertical: false,
...
exports.PpuTransferService = PpuTransferService;
