...
exports.TileBuilderService = void 0;
...
class TileBuilderService {
    ...
    buildCharTile(tileIdx) {
        ...
        if (t < 0xa0) {
            ...
            const lo = scene_bank02_tables_1.TILE_MAP_HIGH[(t - 0xa0) & 0xff] ?? 0x00; // $8A14 高 tile 映射
...
exports.TileBuilderService = TileBuilderService;
