...
const OpeningSceneController_1 = require("./OpeningSceneController");
...
class Scene0Controller extends SceneController_1.SceneController {
    constructor(store, input) {
        ...
        this.tileBuilder = new TileBuilderService_1.TileBuilderService(store, null /* ppu wired at boot */);
    }
    attachAudio(audio) {
        this.audio = audio;
    }
    ...
    onEnter() {
        ...
        this.waitDone = true;
        OpeningSceneController_1.OpeningSceneController.loadStoryCupOam(this.store);
    }
    onUpdate(_frame) {
