...
exports.Scene19Controller = void 0;
/**
...
const EXT_TABLES = [0x0568, 0x0588, 0x05a8, 0x05c8];
class Scene19Controller extends SceneController_1.SceneController {
    constructor() {
        super(...arguments);
        this.sceneId = 19;
        this.iter = 0;
...
exports.Scene19Controller = Scene19Controller;
