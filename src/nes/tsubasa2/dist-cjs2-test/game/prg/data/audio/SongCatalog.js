...
exports.SONG_COUNT = exports.SONGS = exports.COMMAND_TABLE = exports.DURATION_TABLE = exports.FREQUENCY_TABLE = void 0;
exports.lookupSong = lookupSong;
const index_1 = require("./bgm/index");
const index_2 = require("./se/index");
// ════════════════════════════════════════════════════
...
function pseudoChannels(requestId) {
...
function buildSongs() {
    ...
    for (const s of index_1.BGM_SONGS)
        put(s);
    for (const s of index_2.SE_SONGS)
        put(s);
    return out;
}
/**
...
/** BGM 数量 */
exports.SONG_COUNT = index_1.BGM_SONGS.length + index_2.SE_SONGS.length;
/** 查表：requestId → SongRecord（null = 未注册） */
function lookupSong(requestId) {
    return exports.SONGS.get(requestId & 0xFF) ?? null;
}
