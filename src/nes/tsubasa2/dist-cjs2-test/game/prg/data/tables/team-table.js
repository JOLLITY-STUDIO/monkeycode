...
exports.TEAMS_FULL = exports.TEAM_TABLE = void 0;
exports.findTeamById = findTeamById;
exports.findTeamNameById = findTeamNameById;
exports.findRosterById = findRosterById;
const team_roster_1 = require("./team-roster");
/** 兼容 TeamEntry 形状的 TEAM_TABLE（已从 ROM 提取） */
exports.TEAM_TABLE = team_roster_1.TEAM_TABLE;
/** 完整阵容表（含 type/subs/formation/tactic） */
exports.TEAMS_FULL = team_roster_1.TEAM_ROSTER_TABLE;
/** 按 ID 查询队伍 */
...
function findRosterById(id) {
    return (0, team_roster_1.findRosterById)(id);
}
