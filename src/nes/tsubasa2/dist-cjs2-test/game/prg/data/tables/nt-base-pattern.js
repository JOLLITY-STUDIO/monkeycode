...
exports.NT_BASE_PATTERN_TABLE = void 0;
exports.ntBasePattern = ntBasePattern;
/**
...
function ntBasePattern(idx) {
    return exports.NT_BASE_PATTERN_TABLE[(idx & 0x0f)];
}
