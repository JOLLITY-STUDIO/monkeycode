...
const RamViews_1 = require("./RamViews");
class DataStore {
    constructor() {
         ...
         *   推到 PPU spriteMem。
         */
        this.shadowOam = new Uint8Array(0x100);
        /** VRAM 暂存 $2000-$3FFF（无写透目标时的挂起写；attach 后 flush） */
        this.vram = new Uint8Array(0x2000);
        /** VRAM 脏标记（$2000-$3FFF 相对偏移位图） */
        this.vramDirty = new Uint32Array(0x2000 / 32);
        /** VRAM 写透目标（由运行时 attach，见 setVramTarget） */
        this.vramTarget = null;
        /** 帧计数（NMI 帧号） */
        this.frame = 0;
        this.scene = new RamViews_1.SceneView(this);
        this.palette = new RamViews_1.PaletteView(this);
        this.oam = new RamViews_1.OamView(this);
        this.ppuState = new RamViews_1.PpuStateView(this);
        this.fade = new RamViews_1.FadeView(this);
        this.audioState = new RamViews_1.AudioStateView(this);
        this.renderQueue = new RamViews_1.RenderQueueView(this);
        this.matchRound = new RamViews_1.MatchRoundView(this);
        this.matchEvent = new RamViews_1.MatchEventView(this);
        this.playerMove = new RamViews_1.PlayerMoveView(this);
        this.playerName = new RamViews_1.PlayerNameView(this);
    }
    ...
    setVramTarget(target) {
        if (this.vramTarget === target)
            return;
        if (target)
            this.flushVram(target);
