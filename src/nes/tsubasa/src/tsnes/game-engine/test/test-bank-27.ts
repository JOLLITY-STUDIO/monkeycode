...
// ── 加载 code 模块 ──
const bank27 = require('../native-game/tsubasa/banks/prg/bank-27-player-data-code');
...
// ── 加载 data 模块 ──
const data27 = require('../native-game/tsubasa/banks/prg/bank-27-player-data-data');
