...
| 2 | $8000 (SWITCHABLE) | 1828 (22%) | 245 (3%) | 6119 (75%) | 📭 低利用率 | 场景/密码/选择界面 & 多 bank 交织数据迭代器 ($A72C) |
| 3 | $8000 (SWITCHABLE) | 0 (0%) | 8186 (100%) | 6 (0%) | 📦 数据密集型 | 游戏数据表 (Part 1) — 被 $A72C 以 mask=$03 交织读取 |
| 4 | $8000 (SWITCHABLE) | 0 (0%) | 8158 (100%) | 34 (0%) | 📦 数据密集型 | 游戏数据表 (Part 2) — 同 Bank 03 格式，同为 $A72C 交织读取 |
| 5 | $8000 (SWITCHABLE) | 0 (0%) | 8157 (100%) | 35 (0%) | 📦 数据密集型 | 队伍阵型/策略数据 — 纯数据 |
| 6 | $8000 (SWITCHABLE) | 0 (0%) | 3345 (41%) | 4847 (59%) | 📦 数据密集型 | 剧情/脚本数据块 (Part 1) |
| 7 | $8000 (SWITCHABLE) | 0 (0%) | 3908 (48%) | 4284 (52%) | 📦 数据密集型 | 游戏数据表 (Part 3) — 被 $A72C 以 mask=$07 读取 |
...
### Bank 02 — 场景/密码/选择界面 & 多 bank 交织数据迭代器
...
**类型:** 纯数据 bank — 结构化游戏记录表

---

### Bank 04 — 游戏数据表 (Part 2) — 纯数据
