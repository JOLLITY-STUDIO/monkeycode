...
const data = {
  ...
  soundEffectMap: {
    ...
    entries: [
      { seId: 0x01, basePtr: "$8E42", desc: "Sound 0: 8通道全指向$8E5A($FF)→全静音(立即返回)", bank: "12" },
      { seId: 0x02, basePtr: "$8E5B", desc: "Sound 1: 4通道全指向$8E67($FF)→全静音", bank: "12" },
      { seId: 0x03, basePtr: "$8E68", desc: "Sound 2: 通道数据起始于$8E68→ch0/1/3 active", bank: "12" },
      { seId: 0x04, basePtr: "$8E89", desc: "Sound 3: ch0/1→$8E92, ch3→$8E93(共享数据块不同偏移)", bank: "12" },
      { seId: 0x05, basePtr: "$8ECF", desc: "Sound 4: 音效数据", bank: "12" },
      { seId: 0x06, basePtr: "$8F14", desc: "Sound 5", bank: "12" },
      { seId: 0x07, basePtr: "$8FAD", desc: "Sound 6", bank: "12" },
      { seId: 0x08, basePtr: "$8FBB", desc: "Sound 7", bank: "12" },
      { seId: 0x09, basePtr: "$902D", desc: "Sound 8", bank: "12" },
      { seId: 0x0A, basePtr: "$9062", desc: "Sound 9", bank: "12" },
      { seId: 0x0B, basePtr: "$90C6", desc: "Sound 10", bank: "12" },
      { seId: 0x0C, basePtr: "$9235", desc: "Sound 11", bank: "12" },
      { seId: 0x0D, basePtr: "$911D", desc: "Sound 12", bank: "12" },
      { seId: 0x0E, basePtr: "$9181", desc: "Sound 13", bank: "12" },
      { seId: 0x0F, basePtr: "$91EA", desc: "Sound 14", bank: "12" },
      { seId: 0x10, basePtr: "$9079", desc: "Sound 15", bank: "12" },
      { seId: 0x11, basePtr: "$8F5A", desc: "Sound 16", bank: "12" },
      { seId: 0x12, basePtr: "$942D", desc: "Sound 17", bank: "12" },
      { seId: 0x13, basePtr: "$9462", desc: "Sound 18", bank: "12" },
      { seId: 0x14, basePtr: "$94C6", desc: "Sound 19", bank: "12" },
      { seId: 0x15, basePtr: "$92CC", desc: "Sound 20", bank: "12" },
      { seId: 0x16, basePtr: "$8EEC", desc: "Sound 21", bank: "12" },
      { seId: 0x17, basePtr: "$8EF4", desc: "Sound 22: 待分析", bank: "12" },
      { seId: 0x18, basePtr: "$96CC", desc: "Sound 23", bank: "12" },
      { seId: 0x19, basePtr: "$9749", desc: "Sound 24", bank: "12" },
      { seId: 0x1A, basePtr: "$9xxx", desc: "Sound 25+ 分布在 Bank 0D/0E/0F", bank: "ext" },
    ],
    note: "通道初始化列表格式: [ch(0-7), ptrLo, ptrHi] × N, 以 ≥$80 字节终止($FF=标准终止符)。$8349-init 扫描到终止符时写 $0F→$4015 并 RTS。",
    note2: "⚠ '死通道'机制: 多通道可指向同一 init list terminator($FF)，它们在 init 时被设置但不发声 — 因 $07AF(chType)=0 直到 $EC 命令激活。多个 channel 可共享数据块不同偏移实现 polyphonic 效果。",
    note3: "⚠ $870D 频率表 vs $8725 时长表是两块独立数据，不可混淆。时长表索引 48-63 的值无效(来自相邻数据区)。",
  },
