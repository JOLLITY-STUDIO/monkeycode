...
const prg_bank_13_1 = __importDefault(require("../../../../rom-data/prg-bank-13"));
// ═══════════════════════════════════════════════════════════════
// RAM 语义键 (替代 NES 内存地址)
// ═══════════════════════════════════════════════════════════════
// 零页
...
class Bank11Service {
    ...
    readU16(addr) {
        return (0, bank11_data_1.readB11U16)(addr);
    }
    ...
    entry_814C() {
        ...
        const scriptPtr = (0, bank11_data_1.readB11ScriptPtr)(s.read(KEY_0524));
    ...
    fn_81A7(a) {
        ...
        const idx = a & 0x0f;
        const dst = (0, bank11_data_1.readB11TableA)(idx);
    ...
    entry_81BC(a) {
        ...
        const idx = a & 0x0f;
        const dst = (0, bank11_data_1.readB11TableB)(idx);
        switch (dst & 0xffff) {
            case 0x81cc:
                this.entry_81CC();
                break;
    ...
    entry_81CC() {
        ...
        const a = (0, bank11_data_1.readB11Disp81D5)(x); // LDA $81D5,X
    ...
    entry_81CF() {
        const s = this._store;
        let a = (0, bank11_data_1.readB11Disp81D5)(s.read(KEY_003A));
        this.entry_832B(a); // JMP $832B
    }
    /**
    ...
    entry_824D() {
        ...
        // $8273: JMP $8279
        const a2 = (0, bank11_data_1.readB11Disp827F)(x); // LDA $827F,X
    ...
    entry_8276() {
        const x = this.entry_82F7(); // JSR $82F7 → X
        const a = (0, bank11_data_1.readB11Disp827F)(x); // $8279: LDA $827F,X
        this.entry_832B(a); // JMP $832B
    }
    /**
    ...
    entry_827C() {
        ...
        const a = (0, bank11_data_1.readB11Disp827F)(x);
        this.entry_832B(a); // JMP $832B
    }
    // ──────────────────────────────────────────────
    // $82F7: 入口 — 位移 (Y 方向标志)
    ...
    fn_845C() {
        ...
        if (s.read(KEY_05DF) & 0x80) {
            ...
            a = (a >> 1) & 0xff;
            if (carry)
                x = 0x8c; // $8474-$8476: BCC $8478 / LDX #$8C
        }
        else {
            ...
            a = (a >> 1) & 0xff;
            if (carry)
                x = 0xe4; // $846B-$846D: BCC $8478 / LDX #$E4
        }
        // $8478: STX ram_05E1; STA ram_05E2
        s.write(KEY_05E1, x);
        s.write(KEY_05E2, a);
    ...
    fn_847F() {
        ...
        const p = this._getPtr(KEY_0052, KEY_0053);
        const np = (0, bank11_data_1.readB11U16)(p + y); // $8488-$848C: LDA (ram_0052),Y / INY
    ...
    fn_8525(tile, y0) {
        ...
        const tv = (0, bank11_data_1.readB11TUnitTile)(tile & 0xff);
    ...
    fn_85C2(a, y, x) {
        ...
        const ca = s.read(KEY_05CA);
        const pat = (0, bank11_data_1.readB11PatternAttr)(ca, y);
        ...
        const src = bank === 0x12 ? prg_bank_12_1.default : prg_bank_13_1.default;
    ...
    fn_86D3(a) {
        ...
        let v = (0, bank11_data_1.readB11Attr)((a >> 2) & 0xff); // $86D9-$86DC: LSR LSR; LDA $8B42,Y
...
exports.Bank11Service = Bank11Service;
