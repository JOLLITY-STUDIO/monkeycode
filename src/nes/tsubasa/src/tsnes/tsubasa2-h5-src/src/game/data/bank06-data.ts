 ...
 *
 * 数据归属:
 *   - 脚本/剧情字节码 (0x000C-0x05FF): 属脚本系统, 见 data/scene/textscript/scripts-bank-06.ts (stub 待解析)
 *   - 调色板 (0x1000-0x17FF): 属 PPU 调色板系统, 见 ppu/pallete/scene-palette-table.ts
 *
 * TODO:
 *   - 0x000C-0x05FF 的脚本数据尚未正确解析, 6 个入口指针
 *     ($A00C/$A01B/$A028/$A0E0/$A1A8/$A2F2) 的语义需对照
 *     bank00 $84E7 分派器与 $8AEC 脚本 ID 映射表确认
 */
